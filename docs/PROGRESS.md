...
- [done 2026-07-17] RC34 closed as not needed: RA38 richer map sheets meet acceptance with existing place, listing, event, comment, and sticker payloads plus Person B marker/detail routes; no external Mapbox place-details route, key, provider, or abstraction was added
